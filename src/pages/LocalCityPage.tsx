...
const SERVICES: Record<string, {
  ...
  okna: {
    ...
    intro: "Изготовление на заказ и монтаж пластиковых окон в Иркутске. Немецкий профиль VEKA, фурнитура MACO, монтаж по ГОСТу.",
    advantages: [
      { icon: "🏭", title: "Изготовление на заказ", text: "Окна изготавливаются по вашим размерам на партнёрском производстве в Иркутске. Контролируем каждый этап — от замера до монтажа." },
  ...
  const seoData = (() => {
    ...
    if (serviceKey === "ventilyaciya") {
      return {
        ...
        description: `Монтаж вентиляции ${loc} под ключ: бризеры Тион, рекуператоры Vakio, приточно-вытяжные системы. Проектирование, изготовление воздуховодов на заказ, пуско-наладка. Гарантия 2 года, выезд 0 ₽.`,
      };
    }
