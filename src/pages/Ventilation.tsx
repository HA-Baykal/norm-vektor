        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-6 grid lg:grid-cols-3 gap-6 text-sm leading-7 text-slate-700">
            <div className="space-y-3">
              ...
              <p>Работаем в квартирах, частных домах, офисах, ресторанах и на производстве. Воздуховоды изготавливаем на заказ в Иркутске — точная подгонка под объект, минимум стыков и шума.</p>
            </div>
            <div className="space-y-3">
