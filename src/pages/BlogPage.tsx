...
export const articles = [
  {
    slug: "vakio-pritochno-vytyazhnaya-ustanovka",
    date: "2026-09-16",
    title: "Vakio: приточно-вытяжная установка — что это, как работает и почему приборы ставят парой",
    excerpt:
      "Vakio — это не «ещё один бризер», а приточно-вытяжная установка с рекуперацией. Разбираем принцип реверса, работу двух приборов в противофазе, КПД до 90% и то, что важно знать до монтажа в квартире.",
    category: "Вентиляция",
    icon: "💨",
    readTime: "8 мин",
  },
  ...
  {
    slug: 'ventilyaciya-v-kafe-i-magazine-v-irkutske-trebovaniya-oshibki-montazha-i-kak-ih-izbezhat',
    date: '2026-09-17',
    title: 'Вентиляция в кафе и магазине в Иркутске: требования, ошибки монтажа и как их избежать',
    excerpt: 'Открыть кафе или магазин — это только половина дела. Вторая половина — сделать так, чтобы внутри было чем дышать, а проверяющие не выписали штраф. Вентиляция для коммерческого помещения — это не «поставим кондиционер, и нормально». Это инже',
    category: 'Вентиляция',
    icon: 'FileText',
    readTime: '9 мин',
  },
  {
    slug: 'osteklenie-balkonov-i-lodzhij-v-irkutske-teplyj-ili-holodnyj-variant-chto-vybrat',
    date: '2026-09-18',
    title: 'Остекление балконов и лоджий в Иркутске: тёплый или холодный вариант — что выбрать',
    excerpt: 'Балкон в Иркутске — это отдельная история. Летом на нём приятно пить чай, а зимой он превращается в холодную кладовку, куда лишний раз не выйдешь. Многие задумываются об остеклении, но упираются в главный вопрос: делать тёплый вариант или х',
    category: 'Вентиляция',
    icon: 'FileText',
    readTime: '7 мин',
  },
  {
    slug: 'obogrev-kondicionerom-zimoj-v-sibiri-realno-li-sekonomit-na-otoplenii',
    date: '2026-09-18',
    title: 'Обогрев кондиционером зимой в Сибири: реально ли сэкономить на отоплении',
    excerpt: 'Иркутская зима — это не «прохладно». Это -30°C и ниже, ветер, промёрзшие стены и счета за отопление, которые многие жители Иркутска, Ангарска и Шелехова считают самой тяжёлой строкой в семейном бюджете. Неудивительно, что всё чаще люди смот',
    category: 'Кондиционеры',
    icon: 'FileText',
    readTime: '5 мин',
  }
