...
export default function Home() {
  useSeo(
    ...
    "Вектор Комфорта в Иркутске: изготовление на заказ и монтаж пластиковых окон VEKA, продажа и установка кондиционеров, вентиляция и бризеры, алмазное бурение. Гарантия до 5 лет, бесплатный замер, работаем в пригороде до 50 км."
  );
          ...
          <div className="grid lg:grid-cols-12 gap-12 items-center">
            <div className="lg:col-span-7">
              ...
              <p className="text-base sm:text-xl text-slate-300 mb-8 max-w-2xl leading-relaxed">
                4 экспертных направления в Иркутске. Изготавливаем окна VEKA на заказ, устанавливаем кондиционеры, вентиляцию и выполняем алмазное бурение под ключ с гарантией до 5 лет.
              </p>
