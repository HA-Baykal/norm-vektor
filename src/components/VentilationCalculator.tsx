    ...
    <section id="calculator" className="bg-white py-14 sm:py-20 lg:py-28">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-2xl sm:text-3xl font-black text-[#1a3a5c]">Вентиляция в Иркутске — Ballu OneAir, рекуператоры Vakio от 35 000 ₽</h2>
          <div className="mt-6 grid lg:grid-cols-3 gap-6 text-sm leading-7 text-slate-700">
            <div className="space-y-3">
              <p><strong>Вентиляция в Иркутске</strong> от «Вектор Комфорта» — проектирование, монтаж и обслуживание приточно-вытяжных систем. <strong>Ballu OneAir ASP-100 и ASP-200</strong> — приточные очистители воздуха с многоступенчатой HEPA-фильтрацией от пыли, аллергенов и запахов. <strong>Рекуператоры Vakio</strong> — экономия на отоплении до 80%. <strong>Приточные клапаны КИВ-125</strong> — самое доступное решение от 6 000 ₽. Гарантия 2 года.</p>
            ...
            <div className="space-y-3">
              <p><strong>Ballu OneAir ASP-100</strong> — компактный приточный очиститель воздуха для помещений до 40 м². Подаёт свежий воздух с улицы, очищая его через HEPA-фильтр H13. Работает при закрытых окнах — без шума, пыли и сквозняков. Управление с телефона, Алиса и Маруся. Цена с монтажом — от 39 000 ₽.</p>
              <p><strong>Рекуператор Vakio Base</strong> — приточно-вытяжная система с рекуперацией тепла. Зимой подогревает приточный воздух за счёт вытяжного, экономя до 80% на отоплении. Летом — охлаждает. Компактный, тихий, энергоэффективный. Цена с монтажом — от 35 000 ₽.</p>
            </div>
            <div className="space-y-3">
              <p><strong>Вытяжная вентиляция воздуховодами</strong> — комплексные системы для коттеджей, офисов, ресторанов. Разводка воздуховодов по потолку в шахту, скрытый монтаж за подвесным потолком. Индивидуальный проект под ваше помещение. Стоимость — после бесплатного замера.</p>
          ...
          <div className="max-w-7xl mx-auto mt-8">
            <div className="rounded-2xl bg-slate-50 border border-slate-200 p-5 sm:p-6">
              ...
              <div className="mt-3 grid sm:grid-cols-2 gap-4 text-xs leading-6 text-slate-700">
                <div><strong>Сколько стоит Ballu OneAir ASP-100 с установкой?</strong> От 39 000 ₽ под ключ — включает оборудование, алмазное бурение, монтаж и пуско-наладку. ASP-200 — от 62 000 ₽.</div>
                <div><strong>Чем приточный очиститель отличается от рекуператора?</strong> Приточный очиститель (Ballu OneAir) — только приток с очисткой. Рекуператор (Vakio) — приток + вытяжка с рекуперацией тепла (экономия на отоплении до 80%).</div>
                <div><strong>Можно установить бризер в квартире с готовым ремонтом?</strong> Да, алмазное бурение 132 мм с пылесосом — без пыли и грязи. Монтаж за 2-3 часа, аккуратно и чисто.</div>
                <div><strong>Что такое КИВ-125?</strong> Приточный клапан для естественного притока свежего воздуха. Не требует электричества, самое доступное решение — от 6 000 ₽ с монтажом.</div>
              </div>
            </div>
          </div>
        </div>
