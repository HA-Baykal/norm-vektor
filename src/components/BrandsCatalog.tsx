...
const brandCategories = [
  {
    ...
    brands: [
      { name: "Ballu", logo: "/images/brands/ballu.svg", country: "" },
      { name: "Royal Thermo", logo: "/images/brands/royal-thermo.svg", country: "" },
      { name: "Axioma", logo: "/images/brands/axioma.svg", country: "" },
      { name: "AC ELECTRIC", logo: "/images/brands/ac-electric.svg", country: "" },
      { name: "Electrolux", logo: "/images/brands/electrolux.svg", country: "" },
      { name: "Zanussi", logo: "/images/brands/zanussi.svg", country: "" },
      { name: "Midea", logo: "/images/brands/midea.svg", country: "" },
      { name: "SHUFT", logo: "/images/brands/shuft.svg", country: "" },
      { name: "AURUS", logo: "/images/brands/aurus.svg", country: "" },
