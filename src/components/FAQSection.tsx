...
const faqItems = [
  ...
  },
  {
    ...
    a: "Срок изготовления пластиковых окон — 5-7 рабочих дней. Окна изготавливаем на заказ: профиль VEKA, фурнитура MACO с микропроветриванием. Гарантия на окна — 5 лет, на монтажные работы — 1 год."
  },
  {
