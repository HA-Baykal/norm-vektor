...
const faqItems = [
  ...
  },
  {
    ...
    a: "Срок изготовления окон из профиля VEKA  составляет от 5 до 14 рабочих дней. Стандартный монтаж готового окна занимает 3–4 часа.",
  },
  {
    q: "Сколько стоит и сколько длится установка кондиционера?",
    a: "Стандартный монтаж сплит-системы в готовый ремонт стоит от 18 000 ₽ и занимает от 2,5 до 4 часов. Мы обязательно вакуумируем трассу, проверяем соединения под давлением и убираем за собой весь строительный мусор.",
  },
  {
  ...
  },
  {
    ...
    a: "Гарантия на профиль VEKA — до 5 лет, на кондиционеры и бризеры — от 2 до 5 лет (в зависимости от бренда). На все виды монтажных работ компания «Вектор Комфорта» предоставляет гарантию до 1 год.",
  },
];
