...
export default async function handler(req, res) {
  ...
  const seoCatalog = [
    ...
    { id: "102", name: "Kentatsu Кумо KSGKU-HFRN1", brand: "Kentatsu", price: 24900, type: "Обычный", img: "/api/img-proxy?url=/api/img-proxy?url=https://daichi.business/upload/iblock/7b2/c5j10n4adp10em9pt66k5j0y8nax98gx/942finr4uomtf9rvijzjbgcw1qcqedqn.jpg" },
    ...
    { id: "704", name: "Kentatsu Харуки Инвертор (Haruki Inverter)", brand: "Kentatsu", price: 36900, type: "Инверторный", img: "/api/img-proxy?url=https://daichi.business/upload/iblock/35d/i8gppb9juz0c6w2dktcvrdhspglldprk/kvkrs86cnqxa0jbj59057wkr8wq85v3c.jpg" },
    { id: "705", name: "Kentatsu Юки Инвертор (Yuki)", brand: "Kentatsu", price: 37900, type: "Инверторный", img: "/api/img-proxy?url=https://daichi.business/upload/iblock/182/nlwu2e0gjuhcwusny3nz12za1v5jjky8/3hqat1am2vrzrm3lqhxydg1erhr3biy6.jpg" },
    { id: "706", name: "Kentatsu Тиба (Tiba)", brand: "Kentatsu", price: 25500, type: "Обычный", img: "/api/img-proxy?url=https://daichi.business/upload/iblock/7b3/df23o7hj6c0h8t1kq06gi5e10f2ah7bj/5zmzzsbkyns0vccq040tffxxzfl4w7sb.jpg" },
    { id: "707", name: "Kentatsu Тиба Инвертор (Tiba Inverter)", brand: "Kentatsu", price: 35500, type: "Инверторный", img: "/api/img-proxy?url=https://daichi.business/upload/iblock/a78/ytazgd597v41ilczdrmrrv4syrpuxx8o/d8l5w36v6cbhzzfe03w665m96vml3vml.jpg" },
    { id: "708", name: "Kentatsu Отари Инвертор (Otari)", brand: "Kentatsu", price: 38900, type: "Инверторный", img: "/api/img-proxy?url=https://daichi.business/upload/iblock/bd1/btldz2xh2db6xcmfpkv2ky4ymd9dpepo/2n4j4slqymgf3f9a9vtlzvjn2snageuz.jpg" },
    { id: "709", name: "Kentatsu Семпай Инвертор (Sempai)", brand: "Kentatsu", price: 41900, type: "Инверторный", img: "/api/img-proxy?url=https://daichi.business/upload/iblock/5f7/cq4etos1axlspiy21prliijcaknurk3i/pt627l1g4wvgg977c8zlb9z836ln48eu.jpg" },
    { id: "710", name: "Kentatsu Омори Инвертор (Omori)", brand: "Kentatsu", price: 42900, type: "Инверторный", img: "/api/img-proxy?url=https://daichi.business/upload/iblock/20d/bnrk0pfjyycxogd34r5f6ibeeycq1qdz/s3ocdcm1goojpudn0p7o3zt50137vz3z.jpg" },
    { id: "711", name: "Kentatsu Тамаши Инвертор (Tamashi)", brand: "Kentatsu", price: 44900, type: "Инверторный", img: "/api/img-proxy?url=https://daichi.business/upload/iblock/22c/8xen9zd3mi65cbjemfhrhumiwseerhwh/74tssw48ny4jx3nb0jdfn64u7j50fr98.jpg" },
    { id: "712", name: "Kentatsu Токачи Инвертор (Tokachi)", brand: "Kentatsu", price: 45900, type: "Инверторный", img: "/api/img-proxy?url=https://daichi.business/upload/iblock/63a/np8k2wxvwdtysrt5m16mp1zn5l30xvup/662mnq4x7csfd7r0xs9st1e7441zc2h2.jpg" },
    { id: "713", name: "Kentatsu Ичи Инвертор R32 (Ichi)", brand: "Kentatsu", price: 43900, type: "Инверторный", img: "/api/img-proxy?url=https://daichi.business/upload/iblock/629/47fh7nuvm89kjevtvus0veigy97ak817/1472051cafa413bc982fbc6f387cb4c6.jpg" },
    { id: "601", name: "Kentatsu кассетная KSVB Inverter (R32)", brand: "Kentatsu", price: 79900, type: "Полупромышленный", img: "/api/img-proxy?url=https://daichi.business/upload/iblock/bc2/vnbdycr4m92g4cgqqxin08a64435ys9b/h5hwvcm9l2ryn4aw3th4tcvfe3zo8sf7.jpg" },
    { id: "602", name: "Kentatsu кассетная KSVT / KSVG (On/Off)", brand: "Kentatsu", price: 68900, type: "Полупромышленный", img: "/api/img-proxy?url=https://daichi.business/upload/iblock/3a2/9iy11ffuroji91vylb0nqsjnpehio98q/2fcvtlh0tdui4hrr3vayrqqxv567oi3t.jpg" },
    { id: "109", name: "Midea Парамаунт R32 MSAG1", brand: "Midea", price: 27900, type: "Обычный", img: "/api/img-proxy?url=https://daichi.business/upload/iblock/a84/1jv0tyag8mhxoost9mrenn0rxno5m7zx/3qagaezojpctuc631r9cj5iqiok1zttl.jpg" },
    { id: "720", name: "Midea Анлимитед (Unlimited)", brand: "Midea", price: 26900, type: "Обычный", img: "/api/img-proxy?url=https://daichi.business/upload/iblock/258/bdlxz07diy2b2xmjl6d1045bva3ttd12/0ce9a9d3cffe27d8a1d15c1d56330c7e.jpg" },
    { id: "721", name: "Midea Персона (Persona)", brand: "Midea", price: 28900, type: "Обычный", img: "/api/img-proxy?url=https://daichi.business/upload/iblock/8de/sw0yaovmpbbnsu4o07nvkabzsnaf2apd/uke0gs7af5e14gf13pwx45d1mr55hclg.jpg" },
    { id: "722", name: "Midea Персона Инвертор Wi-Fi (Persona)", brand: "Midea", price: 37900, type: "Инверторный", img: "/api/img-proxy?url=https://daichi.business/upload/iblock/c20/8y6cdcyh37erhgwtkqchci26g3eg84qo/nms1q5nx2cwgs2z8sd91x89mm5w4xepc.jpg" },
    { id: "723", name: "Midea Breezeless E", brand: "Midea", price: 44900, type: "Инверторный", img: "/api/img-proxy?url=https://daichi.business/upload/iblock/89a/im8aabeni1x8kr5nuun7tzf8go49k9tx/l0l0me23jov1jctumuj4d43o21ug99xh.jpg" },
    { id: "724", name: "Midea Breezeless Wi-Fi", brand: "Midea", price: 48900, type: "Инверторный", img: "/api/img-proxy?url=https://daichi.business/upload/iblock/71e/qao0l5cxixhqgl1znmbwjpvrho9ch0f9/tah8bpmg2q34vv90ntd29vtf47kh1m3f.jpg" },
    { id: "725", name: "Midea ХитФорс (HeatForce)", brand: "Midea", price: 38900, type: "Инверторный", img: "/api/img-proxy?url=https://daichi.business/upload/iblock/849/hy624qiggawuk84n3442mftfoiallyhk/a9fa6gs2f3js8wtif3kil0vtnami558j.jpg" },
    { id: "726", name: "Midea Гайа (Gaia)", brand: "Midea", price: 46900, type: "Инверторный", img: "/api/img-proxy?url=https://daichi.business/upload/iblock/84f/ujkvgz3xq9zcfuuy4e7f1or1ramu3v0c/j3vyj3tlqrvu7gywlb87ic3q08aai9x9.png" },
    { id: "727", name: "Midea Изи Инвертор (Easy Inverter)", brand: "Midea", price: 39900, type: "Инверторный", img: "/api/img-proxy?url=https://daichi.business/upload/iblock/0bd/6srwuc75bh2v76shtfllx87kwinxbrlh/2ncy0wxu52r3b5g0yzs5f32093tend2n.jpg" },
    { id: "603", name: "Midea кассетная MCD Inverter (R32)", brand: "Midea", price: 82900, type: "Полупромышленный", img: "/api/img-proxy?url=https://daichi.business/upload/iblock/9f5/mh1xbdjyf8dp09n44pa8gllpj2qvyoa6/0f20438fc20d0288aced2d224525178d.jpg" },
    { id: "604", name: "Midea кассетная MCD (On/Off, R410A)", brand: "Midea", price: 71900, type: "Полупромышленный", img: "/api/img-proxy?url=https://daichi.business/upload/iblock/917/j4iyoqyh6vr8qktarcgdf6ia6un21rf7/21988923e1f21957e0ec855c5c2ceb53.jpg" },
    { id: "511", name: "Daikin FTXF Sensira", brand: "Daikin", price: 79800, type: "Инверторный", img: "/api/img-proxy?url=https://daichi.business/upload/iblock/cc6/jm34hyl3p2sxj39pdlpe46fzr56d21kn/7733ead2a8e2b48b0e680ea8b9a65aa7.jpg" },
    { id: "512", name: "Daikin FTXF-F", brand: "Daikin", price: 119700, type: "Инверторный", img: "/api/img-proxy?url=https://daichi.business/upload/iblock/238/s6691tajccy0ton6x3oktjmquou43tbd/nx9knz1eowu2yd1gyg3n963f0x18nvzy.jpg" },
    { id: "513", name: "Daikin FTXS", brand: "Daikin", price: 101100, type: "Инверторный", img: "/api/img-proxy?url=https://daichi.business/upload/iblock/0fc/z4dj26hjdhyuy2iqe7qxr53fuemdpr7j/96f81f5581e5a23877fded7dde9bd161.jpg" },
    { id: "514", name: "Daikin FTYN (On/Off)", brand: "Daikin", price: 48600, type: "Обычный", img: "/api/img-proxy?url=https://daichi.business/upload/iblock/6fd/1h7ebge4871n6k5jlfdj4lftu1m8rr9y/9400fc8f20307af86600f9c5a6d7e74e.jpg" },
    { id: "515", name: "Daikin FTXJ Emura", brand: "Daikin", price: 145000, type: "Инверторный", img: "/api/img-proxy?url=https://daichi.business/upload/iblock/3c7/rdj04unfv0zjvxzk19x10mogl06oxlcw/5849920929240c4125cdbcba7f4ababc.jpg" },
    { id: "516", name: "Daikin FTXM Perfera", brand: "Daikin", price: 135000, type: "Инверторный", img: "/api/img-proxy?url=https://daichi.business/upload/iblock/8e1/18cuonr7cbh7lew9i624rq94xpzra42w/5ur073eya56kmf8jk8d6bga8nwtjiahe.jpg" },
    { id: "517", name: "Daikin FTXM-A Perfera", brand: "Daikin", price: 139000, type: "Инверторный", img: "/api/img-proxy?url=https://daichi.business/upload/iblock/713/bfow3r76etx8zrwn16at1aa16itub6ce/bd521ea7c974f219c2fc9052b3f145cf.jpg" },
    { id: "518", name: "Daikin FTXJ-AB9", brand: "Daikin", price: 149000, type: "Инверторный", img: "/api/img-proxy?url=https://daichi.business/upload/iblock/790/13thzdv5h53mov9w90oc25mr57g83jar/5c5gt4liasw9y3vpun4vr6yy9xuuv5tk.jpg" },
    { id: "519", name: "Daikin FVXM/RXM (напольная)", brand: "Daikin", price: 155000, type: "Инверторный", img: "/api/img-proxy?url=https://daichi.business/upload/iblock/bdb/yhcea9l1iht209vok0q2jgea8qc9inv1/f2ad1aadbbc3e6e14b0c057d815ad5d2.jpg" },
    { id: "520", name: "Daikin FDXM-F9 (канальная)", brand: "Daikin", price: 142000, type: "Инверторный", img: "/api/img-proxy?url=https://daichi.business/upload/iblock/e5b/gip31spgtz0ffdub0pkfacoiy9pyuisy/66342be67326921674b2d43f50afa5db.jpg" },
    { id: "730", name: "Bosch Climate Line 2000", brand: "Bosch", price: 29900, type: "Обычный", img: "/api/img-proxy?url=https://daichi.business/upload/iblock/6f2/2pn2gt1eprib2ko14euxtjcgxkimqy6s/55j8bc0p9aul52jzpp7xa0o0p3ujc8ik.jpg" },
    { id: "731", name: "Bosch Climate Line 5000 Инвертор", brand: "Bosch", price: 42900, type: "Инверторный", img: "/api/img-proxy?url=https://daichi.business/upload/iblock/653/v1z2i0rg7r2uwy1uh130b46n2stau7vo/65ad09a0d15c6d813071a62646dbf60c.jpg" },
    { id: "732", name: "Bosch Climate 5000 Инвертор", brand: "Bosch", price: 44900, type: "Инверторный", img: "/api/img-proxy?url=https://daichi.business/upload/iblock/653/v1z2i0rg7r2uwy1uh130b46n2stau7vo/65ad09a0d15c6d813071a62646dbf60c.jpg" },
    { id: "733", name: "Bosch Climate 6000i Инвертор", brand: "Bosch", price: 52900, type: "Инверторный", img: "/api/img-proxy?url=https://daichi.business/upload/iblock/32b/0lptf46vnmv7fxubjlaarcvwjtnohd7a/64cf767e224d4b0547533a32da4198f3.jpg" },
    ...
    { id: "108", name: "Daichi Эверест R32 DA-EVQ1R", brand: "Daichi", price: 25900, type: "Обычный", img: "/api/img-proxy?url=https://daichi.business/upload/iblock/7db/9345zuwtjj0x12p8i8h1hjc25p60kwx8/ffcceac8399e0f4dbb7c3f328a8e9963.jpg" },
    ...
    { id: "106", name: "Axioma Серия H R32 ASX-H1R", brand: "Axioma", price: 23900, type: "Обычный", img: "/api/img-proxy?url=https://daichi.business/upload/iblock/729/2yazrrf7llnrycwn7ijzdm3ouy7j3426/ba5f0cb6ed2ca05713043cbbffe9a69e.jpg" },
    { id: "502", name: "Axioma Серия H Инвертор R32", brand: "Axioma", price: 32900, type: "Инверторный", img: "/api/img-proxy?url=https://daichi.business/upload/iblock/b83/5q4sm9gtisizi3ofygnqfn3k1qrgwec7/92e82058c26e611f09bf4655866960ef.jpg" }
  ];
